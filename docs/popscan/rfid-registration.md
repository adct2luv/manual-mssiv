...
description: วิธีลงทะเบียนบัตร RFID บน POPscan
---
...
:::caution ข้อควรระวัง: ประตูต้องเปิดอยู่ตลอดเวลาในขณะทำการลงทะเบียน :::
...
สามารถลงทะเบียนการ์ดได้สูงสุด **200 ใบ**

## โหมดลงทะเบียนการ์ดแบบระบุช่องข้อมูล (Individual Register)

1. ทำตามขั้นตอนที่ 1 ถึง 3 ในการลงทะเบียนแบบทั่วไป
2. ป้อนหมายเลขระบุช่องข้อมูลการ์ดเป็นตัวเลข 3 หลัก (ตั้งแต่ 001 ถึง 200) จากนั้นกดปุ่ม `#` หรือ `*`
