...
const REFERENCE_GUIDES: Manual[] = [
  ...
  {title: 'IR Sensor for Face ID', slug: 'ir-sensor-usage-guide-for-face-id', category: 'guide', size: '0.5 MB'},
  {title: 'Outer Body Cable Management', slug: 'outer-body-cable-management-guide', category: 'guide', size: '0.1 MB'},
  {title: 'Remote Control Compatibility', slug: 'remote-control-module-compatibility-guide', category: 'guide', size: '0.1 MB'},
];
