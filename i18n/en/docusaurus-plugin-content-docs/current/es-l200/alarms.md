...
sidebar_position: 10
title: Alarms & Safety
description: Alarms and safety of ES-L200
---
...
## Emergency Battery Terminal (9V)

If the main batteries are completely dead, connect a 9V alkaline battery to the external terminals to temporarily power the lock and enter your PIN.