...
description: Special features of TRIPLEX 2way
---
...
## home_network_setting

(Optional Settings) This feature lets you open the door remotely via home network devices and Remote Control
...
3. Check if the numbers [1, 2, 3, 7, 8, 9, 0, #] has been lighted on the number pad. And registration is complete

### Deletion Steps

1. Press [Registration] button. Enter pin number. Followed by [✱] button
2. Check if the numbers [1, 2, 3, 7, 8, 9, 0, #] has been lighted. Press [0] button
