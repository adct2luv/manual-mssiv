...
description: Special features of TOUCH
---
...
2. Enter current pin number followed by [✱] button.
3. Check if the numbers [1, 2, 3, 7, 8, 9, 0, #] has been lighted on the number pad. Press number [3] button.
4. Enter new guest pin number to be registered (4~12 digits) and press [✱] button to complete the registration.
...
**Cancellation:** Open the door by the [Manual Knob (lock/unlock)] or by the [Open/Close] button inside and the [Force Lock] will be cancelled.
...
:::note
This is a security feature that prevents the pin number from being exposed, by removing traces of fingerprint patterns on the number pad. The multi-touch feature is disable in default.
:::
...
2. Enter current pin number. When you press [✱] button, the front panel LED will blink and light-up.
...
:::note
The pin number & smart card should be registered first before setting this feature
:::
